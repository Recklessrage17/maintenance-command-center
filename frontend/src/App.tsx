...
import { MccLayout, type MccPageLiveStatus, type MccSection } from './layout/MccLayout';
...
function App() {
  ...
  const [inventoryLiveStatus,setInventoryLiveStatus]=useState<MccPageLiveStatus>({state:'refreshing',label:'Refreshing Inventory'});
