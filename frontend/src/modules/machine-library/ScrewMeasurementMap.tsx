...
const flightBands = Array.from({ length: 17 }, (_, index) => 248 + index * 48);
      ...
      <div className="screw-diagram-wrap">
        ...
        >
          ...
          <g className="screw-drive-assembly" filter="url(#screwMapSoftShadow)">
            <text className="screw-drive-label" x="70" y="103">DRIVE /</text>
            <text className="screw-drive-label" x="70" y="119">SPLINE END</text>
