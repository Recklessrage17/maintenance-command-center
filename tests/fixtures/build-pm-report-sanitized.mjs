...
tracker.getRow(4).values=['Press:','100','','Sanitized Press A','','Sanitized Area'];styleSection(4);
styleBlock(5,9,[8,9]);
...
tracker.getRow(14).values=['Press:','200','','Sanitized Press B','','Sanitized Area'];styleSection(14);
styleBlock(15,17,[16]);
...
const populatedHistory=[
  ['100',sharedWorkOrder,'Completed',new Date('2026-06-01T12:00:00Z'),new Date('2026-06-01T12:00:00Z'),'Preventive Maintenance','Sanitized Technician','Days','Inspect guards','PM completed. No issues found.'],
  ['100',sharedWorkOrder,'Completed',new Date('2026-06-02T12:00:00Z'),new Date('2026-06-02T12:00:00Z'),'Preventive Maintenance','Sanitized Technician','Annual','Annual safety review','Annual PM completed. No issues found.'],
  ['200',sharedWorkOrder,'Completed',new Date('2026-06-03T12:00:00Z'),new Date('2026-06-03T12:00:00Z'),'Preventive Maintenance','Sanitized Technician','Days','Inspect guards','PM completed. No issues found.'],
  ['100',sharedWorkOrder,'Completed',new Date('2026-06-01T12:00:00Z'),new Date('2026-06-01T12:00:00Z'),'Preventive Maintenance','Sanitized Technician','Days','Inspect guards','PM completed. No issues found.'],
];
