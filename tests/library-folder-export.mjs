...
class FileResponse extends Writable{
  ...
  _final(callback){fs.close(this.fd,callback);}
}
...
try{
  ...
  console.log('Shareable folder ZIP helper tests passed for nesting, empty folders, duplicate names across directories, safe paths, exact preflight sizes, and 64 MB bounded streaming.');
}finally{
